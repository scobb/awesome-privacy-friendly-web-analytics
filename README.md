# Awesome Privacy-Friendly Web-Analytics [![License: CC BY-NC-SA 4.0](https://licensebuttons.net/l/by-nc-sa/4.0/80x15.png)](https://creativecommons.org/licenses/by-nc-sa/4.0/)
...
|[Beam](https://beam-privacy.com/)<br>([Demo](https://beam-privacy.com/demo), [Privacy Policy](https://beam-privacy.com/privacy))|Commercial|[GitHub](https://github.com/scobb/beam.js) (tracking script)|No cookies. GDPR compliant. Custom events, goals, traffic source channels. Runs on Cloudflare edge.|Free (1 site, 50K pv/mo). Pro $5/month unlimited sites, 500K pv/mo.|[Next.js, WordPress, Astro, Remix](https://beam-privacy.com/docs/api)|
