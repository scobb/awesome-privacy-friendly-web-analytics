...
|[Beam](https://beam.keylightdigital.com/)<br>([Demo](https://beam.keylightdigital.com/demo), [Privacy Policy](https://beam.keylightdigital.com/privacy))|Commercial|[GitHub](https://github.com/scobb/beam.js) (tracking script)|No cookies. GDPR compliant. Custom events, goals, traffic source channels. Runs on Cloudflare edge.|Free (1 site, 5K pv/mo). Pro $5/month unlimited sites, 100K pv/mo.|[Next.js, WordPress, Astro, Remix](https://beam.keylightdigital.com/docs/api)|
