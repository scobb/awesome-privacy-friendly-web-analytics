...
|[Beam](https://beam-privacy.com/)<br>([Demo](https://beam-privacy.com/demo), [Privacy Policy](https://beam-privacy.com/privacy))|Commercial|[GitHub](https://github.com/scobb/beam.js)|No cookies, no fingerprinting. GDPR-compliant by design. Cookie-free unique visitor counting via daily field hashing.|Free: 1 site, 50K views/mo. Pro: $5/month for 500K views.|Cloudflare Workers + D1 edge platform|
